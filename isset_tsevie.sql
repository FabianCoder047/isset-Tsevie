...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 10 nov. 2025 à 15:18
...
(9, '2025-00002', 'DOGBE', 'Fabrice', '2010-11-24', 'NOTSE', 'M', 4, '+228 98 81 34 82', '2025-11-10 13:56:32', '2025-11-10 13:56:32', '2025-11-10 13:56:32');
...
(7, 4, 5, '2025-11-10 14:57:05', '2025-11-10 14:57:05');
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Table des notes des élèves par matière, classe et semestre';

--
-- Déchargement des données de la table `notes`
--

INSERT INTO `notes` (`id`, `eleve_id`, `matiere_id`, `classe_id`, `interro1`, `interro2`, `devoir`, `compo`, `semestre`, `date_saisie`, `derniere_maj`, `saisie_par`) VALUES
(24, 8, 3, 10, 12.00, 14.00, 11.00, 15.00, 1, '2025-11-10 13:46:40', '2025-11-10 13:52:27', 3),
(25, 9, 1, 4, 18.00, 16.00, 19.00, 19.00, 1, '2025-11-10 13:57:11', '2025-11-10 13:57:11', 3);
...
(4, 'AMOUSSOU', 'Patrice', 'patriceamoussou@gmail.com', 'pamoussou', '$2y$10$AdQR8gkx115rnGpHPZbJBuujptwjGMsdWjIMp8QFboxuy46FRa9f.', 'professeur', 'actif', 0, '2025-11-10 01:25:37');
...
--
ALTER TABLE `notes`
  ADD CONSTRAINT `fk_notes_utilisateur` FOREIGN KEY (`saisie_par`) REFERENCES `utilisateurs` (`id`) ON DELETE SET NULL,
