                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:ml-10 md:flex md:space-x-4">
                        ...
                        <div class="relative group">
                            ...
                            <div id="inscription-menu" class="hidden absolute z-10 mt-1 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                                <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="inscription-menu-button">
                                    <a href="<?php echo $secretaire_url; ?>/inscription.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
